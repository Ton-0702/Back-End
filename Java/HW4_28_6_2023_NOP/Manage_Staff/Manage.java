...
public class Manage extends Manage_Staff{
    private int time;
    private int wage_time = 55000; //lương theo giờ
    private String type_staff = "Manager";
    ...
    public Manage(String name, Integer age, String email, int time) {
